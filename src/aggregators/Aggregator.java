...
public abstract class Aggregator {     //this is an abstract class and that means some other class are child of this class
	
	List<Double> numbers;           //any child class has access to this variable "numbers"
